...
class NagiosPluginCommandParams(RobieParamsModel, extra='forbid'):
    """
...
class NagiosPluginParams(RobiePluginParams, extra='forbid'):
    """
    Process and validate the Robie configuration parameters.
    """
    ...
    command: Annotated[
        ...
        Field(default_factory=NagiosPluginCommandParams,
